...
public class ResturantFoodActivity extends AppCompatActivity {
   ...
   List<Food> lstfood;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RestaurantFoodAdapter resfoodadapter = new RestaurantFoodAdapter(ResturantFoodActivity.this,lstfood);
